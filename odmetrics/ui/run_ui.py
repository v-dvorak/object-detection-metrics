...
from ..utils import converter, general_utils
from PyQt5 import QtCore, QtWidgets
from PyQt5.QtWidgets import QFileDialog, QMainWindow, QMessageBox
from ..evaluators.coco_evaluator import get_coco_summary
from ..evaluators.pascal_voc_evaluator import (get_pascalvoc_metrics, plot_precision_recall_curve,
                                                 plot_precision_recall_curves)
from .details import Details_Dialog
from .main_ui import Ui_Dialog as Main_UI
from .results import Results_Dialog
from .splash import Splash_Dialog
